...
The slope value is statistically significant, but the intercept value is not. The first three diagnostic plots below look alright, although there is a slight downward trend happening in the first plot, but this is not 
