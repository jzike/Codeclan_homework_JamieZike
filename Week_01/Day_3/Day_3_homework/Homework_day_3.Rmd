...
```
##Question 1
The first thing I noticed is that the data is formatted correctly, so we
don't need to skip some rows. It looks like there are two variables for title
so I will need to choose between the two. The other variables are named 
